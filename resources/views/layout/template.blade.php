                    ...
                    <div class="container-fluid">
                        ...
                        <div class="header-brand me-5">
                            ...
                            <a href="../../demo10/dist/index.html">
                                <img alt="Logo" src="{{asset('template')}}/media/logos/logo1.png" class="h-25px h-lg-30px d-none d-md-block" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--end::Brand-->
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://www.optikmelawai.com/" target="_blank" class="text-gray-800 text-hover-primary">Optik Melawai</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
                        <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                            <li class="menu-item">
                                <a href="https://www.optikmelawai.com/" target="_blank" class="menu-link px-2">About</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://www.optikmelawai.com/" target="_blank" class="menu-link px-2">Support</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://www.optikmelawai.com/" target="_blank" class="menu-link px-2">Ecommerce</a>
                            </li>
                        </ul>
                        <!--end::Menu-->
                    </div>
