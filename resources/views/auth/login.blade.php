...
<head>
    <base href="../../../">
    <title>Optik Melawai - Doorprize login</title>
    <meta charset="utf-8" />
...
<body data-kt-name="metronic" id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <style>
            body {
                background-image: url('{{asset('template')}}/media/auth/bg_merah.jpg');
            }
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Logo-->
                    <a class="mb-7">
                        <img style="width: 80%;" alt="Logo" src="{{asset('template')}}/media/logos/logomelawai.jpeg" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h2 class="text-white fw-normal m-0">Doorprize application</h2>
                    <!--end::Title-->
                </div>
                <!--begin::Aside-->
            </div>
                    ...
                    <div class="card-body p-10 p-lg-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="separator separator-content my-14">
                                <span class="w-325px text-gray-500 fw-semibold fs-7">Email and Password</span>
                            </div>
                            <!--end::Separator-->
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input placeholder="Your email" id="email" type="email" class="form-control bg-transparent @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <div class="d-grid mb-10">
                                ...
                                <button type="submit" id="kt_sign_in_submit" class="btn btn-primary" hidden>
                            ...
                            <!--end::Submit button-->
                            <!--begin::Sign up-->
                            <div class="text-gray-500 text-center fw-semibold fs-6">2022©
                                <a href="https://www.optikmelawai.com/" class="link-primary">Optik Melawai</a>
                            </div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
